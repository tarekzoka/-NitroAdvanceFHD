#!/bin/bash
######################################################################################
## Command=wget https://raw.githubusercontent.com/tarekzoka/NitroAdvanceFHD/main/installer1.sh -O - | /bin/sh
###########################################
###########################################
#!/bin/sh
echo
...
wait
opkg install --force-overwrite  https://github.com/tarekzoka/NitroAdvanceFHD/blob/main/enigma2-plugin-skins-novaler-s-x-fhd-blue_3.2_all.ipk?raw=true
wait
exit#########################################################
#########################################################
